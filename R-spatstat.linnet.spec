...
Version  : 3.2.3
Release  : 30
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/spatstat.linnet_3.2-3.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/spatstat.linnet_3.2-3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732114723
...
/usr/lib64/R/library/spatstat.linnet/info/packagesizes.txt
